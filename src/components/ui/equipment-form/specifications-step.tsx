            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="DialogContent" aria-describedby="create-category-description">
                        ...
                        <div className="space-y-4 py-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="propertyName"
                                    // value={newCategory}
                                    onChange={(e) => setNewSpec({ ...newSpec, rangeFrom: e.target.value })}
                                    placeholder=""
                                    className="h-12"
                                />
                            </div>
                        ...
                        <div className="space-y-4 py-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="propertyName"
                                    // value={newCategory}
                                    onChange={(e) => setNewSpec({ ...newSpec, rangeTo: e.target.value })}
                                    placeholder=""
                                    className="h-12"
                                />
                            </div>
                    ...
                    <Button
                        ...
                        disabled={!newSpec.name || (!newSpec.value && (!newSpec.rangeFrom || !newSpec.rangeTo))}
                    >
                        Save
                    </Button>
                </DialogContent>
