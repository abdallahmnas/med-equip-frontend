...
const EquipmentFormContext = createContext<EquipmentFormContextType | undefined>(undefined)
...
export function useEquipmentForm() {
    ...
    if (context === undefined) {
        throw new Error('useEquipmentForm must be used within a EquipmentFormProvider')
    }
    return context
}
